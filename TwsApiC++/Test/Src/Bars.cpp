 ...
 public:
  ...
  virtual void tickPrice(TickerId tickerId, TickType field, double price,
    ...
    switch (field) {
      ...
      case TickTypes::Last:
        printf("TP: %4ld %02d:%02d:%02d %15s %5.3f\n", tickerId, _tm->tm_hour,
  ...
  virtual void tickSize(TickerId tickerId, TickType field, int size) {
    ...
    switch (field) {
      case TickTypes::LastSize:
        printf("TP: %4ld %02d:%02d:%02d %15s %5d\n", tickerId, _tm->tm_hour,
  ...
  virtual void tickString(TickerId tickerId, TickType tickType,
    ...
    switch (tickType) {
      case TickTypes::LastTimestamp:
        printf("TP: %4ld %02d:%02d:%02d %15s %02d:%02d:%02d\n", tickerId,
               _tm.tm_hour, _tm.tm_min, _tm.tm_sec, *(TickTypes::ENUMS)tickType,
